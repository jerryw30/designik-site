...
export default function Interactive() {
  ...
  return (
    <section ref={ref} className="relative h-[80vh] min-h-[560px] w-full overflow-hidden bg-wine-700">
      <motion.div style={{ y }} className="absolute inset-0 scale-110">
        <Image src={assets.interactiveScene} alt="" fill priority={false} sizes="100vw" className="object-cover object-center" />
