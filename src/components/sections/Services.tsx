    ...
    <section id="services" className="relative bg-white">
      ...
      <div className="grid gap-4 px-5 py-12 min-[1200px]:hidden sm:grid-cols-2">
        ...
        <article className="group relative min-h-[320px] overflow-hidden rounded-[20px] bg-wine-500 text-white shadow-sm">
          ...
          <Image src={data.cards.digital.image || assets.digitalMarketing} alt="" width={287} height={250} className="absolute left-[39%] top-1/2 h-[90%] w-auto max-w-none -translate-x-1/2 -translate-y-1/2 object-contain object-center" />
        </article>
