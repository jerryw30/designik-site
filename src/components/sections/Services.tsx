  ...
  return (
    <section id="services" className="relative bg-white">
      <div className="relative mx-auto hidden h-[827px] w-[1300px] min-[1200px]:block">
        <article className="group absolute left-[1px] top-[100px] h-[279px] w-[525px] overflow-hidden rounded-[21px] bg-[#fff3e9] will-change-transform transition-[transform,box-shadow] duration-[450ms] ease-[cubic-bezier(0.4,0,0.2,1)] hover:-translate-y-[6px] hover:shadow-[0_18px_45px_rgba(0,0,0,0.12)]">
        ...
        <article className="group absolute left-[546px] top-[100px] h-[339.604px] w-[287.202px] overflow-hidden rounded-[20px] bg-wine-500 will-change-transform transition-[transform,box-shadow] duration-[450ms] ease-[cubic-bezier(0.4,0,0.2,1)] hover:-translate-y-[6px] hover:shadow-[0_18px_45px_rgba(0,0,0,0.12)]">
        ...
        <article className="group absolute left-[854px] top-[305px] h-[135.036px] w-[309.372px] overflow-visible rounded-[20px] bg-[#ffefef] will-change-transform transition-[transform,box-shadow] duration-[450ms] ease-[cubic-bezier(0.4,0,0.2,1)] hover:-translate-y-[6px] hover:shadow-[0_18px_45px_rgba(0,0,0,0.12)]">
        ...
        <motion.article
          ...
          className="group absolute left-[1px] top-[407px] h-[178px] w-[171px] overflow-hidden rounded-[20px] bg-[#ffefef] will-change-transform transition-shadow duration-[450ms] ease-[cubic-bezier(0.4,0,0.2,1)] hover:shadow-[0_18px_45px_rgba(0,0,0,0.12)]">
        ...
        <article className="group absolute left-[192px] top-[407px] h-[340px] w-[287.202px] overflow-hidden rounded-[20px] bg-[#fff3e9] will-change-transform transition-[transform,box-shadow] duration-[450ms] ease-[cubic-bezier(0.4,0,0.2,1)] hover:-translate-y-[6px] hover:shadow-[0_18px_45px_rgba(0,0,0,0.12)]">
        ...
        <article className="group absolute left-[498px] top-[467.821px] h-[279.141px] w-[802.151px] overflow-hidden rounded-[20px] bg-[linear-gradient(176.398deg,#a10140_10.085%,#db2f73_137.48%)] will-change-transform transition-[transform,box-shadow] duration-[450ms] ease-[cubic-bezier(0.4,0,0.2,1)] hover:-translate-y-[6px] hover:shadow-[0_18px_45px_rgba(0,0,0,0.15)]">
