...
export default function Nav() {
  ...
  return (
    ...
    >
      ...
      >
        <a href="#home" className="flex items-center gap-2" aria-label="Designik home">
          <Image src="/figma/vector1.svg" alt="Designik" width={44} height={44} className="h-9 w-9 md:h-10 md:w-10" priority />
        </a>
