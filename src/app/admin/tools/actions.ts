...
export async function importBackup(form: FormData) {
  ...
  // JSON.parse also accepts null, arrays and primitives — reject them before
  // reading properties, otherwise the request dies with an unhandled 500.
  ...
  try {
    ...
    // Surface database failures on the Tools screen instead of a blank 500.
    console.error("Backup import failed:", error);
    redirect("/admin/tools?error=db");
  }
